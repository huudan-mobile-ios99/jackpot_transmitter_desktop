...
class JackpotDisplayV2 extends StatefulWidget {
  const JackpotDisplayV2({Key? key}) : super(key: key);

  @override
  JackpotDisplayV2State createState() => JackpotDisplayV2State();
}

class JackpotDisplayV2State extends State<JackpotDisplayV2> {
