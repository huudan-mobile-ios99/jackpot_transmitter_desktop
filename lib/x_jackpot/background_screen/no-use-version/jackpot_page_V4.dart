...
class JackpotDisplayV4 extends StatefulWidget {
  const JackpotDisplayV4({Key? key}) : super(key: key);

  @override
  JackpotDisplayV4State createState() => JackpotDisplayV4State();
}

class JackpotDisplayV4State extends State<JackpotDisplayV4> {
    ...
    return Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelWeeekly, endValue: jackpotValueLevelWeekly,nameJP:"Weekly")),
                  Positioned(
                    top: ConfigCustom.fixHeight/5.65,
                    right: 16,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelDozen, endValue: jackpotValueLevelDozen,nameJP:"Dozen")),
                  //row center
                  Positioned(
                    top: ConfigCustom.fixHeight/2.23,
                    left:ConfigCustom.fixWidth/50,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelDailyGolden, endValue: jackpotValueLevelDailyGolden,nameJP:"Daily Golden")),
                  Positioned(
                    right:-16,
                    top: ConfigCustom.fixHeight/2.23,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelDaily, endValue: jackpotValueLevelDaily,nameJP:"Daily")),
                  //row bottom
                  Positioned(
                    bottom:ConfigCustom.fixHeight/6.75,
                    left:ConfigCustom.fixWidth/1.85,
                    child: GameOdometerChildStyleOptimized(startValue: previousJackpotValueLevelFrequent, endValue:jackpotValueLevelFrequent ,nameJP:"Frequent"))
                ],
              );
  }
    ...
    return Stack(
                children: [
                  ...
                  Positioned(
                    top: ConfigCustom.fixHeight/5.65,
                    left:ConfigCustom.fixWidth/50,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelVegas, endValue: jackpotValueLevelVegas,nameJP:"Vegas")),
                  Positioned(
                    top: ConfigCustom.fixHeight/5.65,
                    right: 16,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelZMonthly, endValue: jackpotValueLevelZMonthly,nameJP:"Monthly")),
                  //row center
                  Positioned(
                    top: ConfigCustom.fixHeight/2.23,
                    left:38,
                  ...
                  Positioned(
                    right:-16,
                    top: ConfigCustom.fixHeight/2.23,
                    child: GameOdometerChildStyleOptimized(startValue:  previousJackpotValueLevelTripple, endValue: jackpotValueLevelTripple,nameJP:"Tripple")),
                  //row bottom
                  Positioned(
                    bottom:ConfigCustom.fixHeight/6.75,
                    left:38,
                  ...
                  Positioned(
                    bottom:ConfigCustom.fixHeight/6.75,
                    right:0,
                    child: GameOdometerChildStyleOptimized(startValue: previousJackpotValueLevelHighLimit, endValue:jackpotValueLevelHighLimit ,nameJP:"Hight Limit"))
                ],
              );
  }
}
