...
class GameOdometerChildStyle3Small extends StatefulWidget {
  final double startValue;
  final double endValue;
  final int totalDuration; // Total duration in seconds (default: 30)
  final String nameJP;

  const GameOdometerChildStyle3Small({
    Key? key,
  ...
  @override
  _GameOdometerChildStyle3SmallState createState() => _GameOdometerChildStyle3SmallState();
}

class _GameOdometerChildStyle3SmallState extends State<GameOdometerChildStyle3Small>
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildStyle3Small oldWidget) {
