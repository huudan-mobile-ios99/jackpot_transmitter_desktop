...
class GameOdometerChildStyle3BlocPage extends StatefulWidget {
  final double startValue;
  final double endValue;
  final int totalDuration; // Total duration in seconds (default: 30)
  final String nameJP;

  const GameOdometerChildStyle3BlocPage({
    Key? key,
  ...
  @override
  _GameOdometerChildStyle3BlocPageState createState() => _GameOdometerChildStyle3BlocPageState();
}

class _GameOdometerChildStyle3BlocPageState extends State<GameOdometerChildStyle3BlocPage>
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildStyle3BlocPage oldWidget) {
