...
// Example usage
void main() {
  final result = OdometerCalculator.calculateOdometerMetrics(
    startValue: 120.15,
    endValue: 125.56,
    totalDurationMs: 30000,
  );

  print('Second Decimal:');
  print('Full Cycle Duration (0->9): ${result['secondDecimal']['fullCycleDuration'].toStringAsFixed(3)} ms');
  print('Partial Cycle Duration (5->6): ${result['secondDecimal']['partialCycleDuration'].toStringAsFixed(3)} ms');
  print('Full Cycles: ${result['secondDecimal']['fullCycles']}');
  print('Partial Cycle: ${result['secondDecimal']['partialCycle']}');
  print('Total Cycles: ${result['secondDecimal']['totalCycles']}');

  print('\nFirst Decimal:');
  print('Full Cycle Duration (0->9): ${result['firstDecimal']['fullCycleDuration'].toStringAsFixed(3)} ms');
  print('Partial Cycle Duration: ${result['firstDecimal']['partialCycleDuration'].toStringAsFixed(3)} ms');
  print('Full Cycles: ${result['firstDecimal']['fullCycles']}');
  print('Partial Cycle: ${result['firstDecimal']['partialCycle']}');
  print('Total Cycles: ${result['firstDecimal']['totalCycles']}');

  print('\nInteger (Ones):');
  print('Full Cycle Duration (0->9): ${result['integer']['ones']['fullCycleDuration'].toStringAsFixed(3)} ms');
  print('Partial Cycle Duration (0->5): ${result['integer']['ones']['partialCycleDuration'].toStringAsFixed(3)} ms');
  print('Full Cycles: ${result['integer']['ones']['fullCycles']}');
  print('Partial Cycle: ${result['integer']['ones']['partialCycle']}');
  print('Total Cycles: ${result['integer']['ones']['totalCycles']}');

  print('\nInteger (Tens):');
  print('Full Cycle Duration (0->9): ${result['integer']['tens']['fullCycleDuration'].toStringAsFixed(3)} ms');
  print('Partial Cycle Duration: ${result['integer']['tens']['partialCycleDuration'].toStringAsFixed(3)} ms');
  print('Full Cycles: ${result['integer']['tens']['fullCycles']}');
  print('Partial Cycle: ${result['integer']['tens']['partialCycle']}');
  print('Total Cycles: ${result['integer']['tens']['totalCycles']}');

  print('\nInteger (Hundreds):');
  print('Full Cycle Duration (0->9): ${result['integer']['hundreds']['fullCycleDuration'].toStringAsFixed(3)} ms');
  print('Partial Cycle Duration: ${result['integer']['hundreds']['partialCycleDuration'].toStringAsFixed(3)} ms');
  print('Full Cycles: ${result['integer']['hundreds']['fullCycles']}');
  print('Partial Cycle: ${result['integer']['hundreds']['partialCycle']}');
  print('Total Cycles: ${result['integer']['hundreds']['totalCycles']}');
}
